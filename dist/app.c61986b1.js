...
var View = function () {
  ...
  View.prototype.setTemplate = function (key, value) {
...
var Router = function () {
  ...
  Router.prototype.setDefault = function (page) {
    this.defaultRoute = {
      path: "",
      page: page
    };
...
var NewsFeedView = function (_super) {
  ...
  NewsFeedView.prototype.render = function () {
    ...
    this.setTemplate("next_page", String(Math.ceil(this.feeds.length / 10) > store.currentPage ? store.currentPage + 1 : store.currentPage));
    this.updateView();
  };
...
router.setDefault(newsFeedView);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9247" + '/');
