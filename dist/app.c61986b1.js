...
function newsFeed() {
  ...
  template = template.replace("{{__next_page__}}", String(Math.ceil(newsFeed.length / 10) > store.currentPage ? store.currentPage + 1 : store.currentPage));
  updateView(template);
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13038" + '/');
